...
namespace AcademicCenter
{
    public static class Configuration
    {
        ...
        public static List<Discipline> GetDisciplines()
        {
            ...
            var tmp = Directory.GetFiles(JsonSettings.FolderPath + "\\discipline\\","*.json", SearchOption.TopDirectoryOnly);
            ...
            {
                new Discipline().Save(JsonSettings.FolderPath + "\\discipline\\default.json");
